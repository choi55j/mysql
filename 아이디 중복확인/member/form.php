...
<head>
    ...
    <script>
        ...
        function check_id(){
            window.open("check_id.php?id=" +document.member.id.value,"lDcheck","left=700,top=300,width=380,heguht=160,scrollbars=no,resizeable=yes");
        }
    </script>
</head>
<body>
    <form action="insert.php" name="member" method="post">
        <h2>회원가입</h2>
        <ul class="join_form">
            <li>
